...
$(WASM_BUILD_DIR)/el-passo-rp.js : test-wasm/el-passo-rp.cc $(MCL_DIR)/src/fp.cpp $(SRCS)
	mkdir -p $(@D)
	$(EMCC) -o $@ test-wasm/el-passo-rp.cc src/ps-verifier.cc src/ps-encoding.cc $(MCL_DIR)/src/fp.cpp $(EMCC_OPT) -DMCL_DONT_USE_XBYAK -DMCL_DONT_USE_OPENSSL -DMCL_USE_VINT -DMCL_SIZEOF_UNIT=8 -DMCL_VINT_64BIT_PORTABLE -DMCL_VINT_FIXED_BUFFER -DMCL_MAX_BIT_SIZE=384
