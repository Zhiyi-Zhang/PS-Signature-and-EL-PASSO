...
$(WASM_BUILD_DIR)/wasm-tests.js : wasm-src/wasm-tests.cc $(MCL_DIR)/src/fp.cpp $(SRCS)
	mkdir -p $(@D)
...
$(WASM_BUILD_DIR)/el-passo-idp.js : wasm-src/el-passo-idp.cc $(MCL_DIR)/src/fp.cpp $(SRCS)
	mkdir -p $(@D)
...
$(WASM_BUILD_DIR)/el-passo-rp.js : wasm-src/el-passo-rp.cc $(MCL_DIR)/src/fp.cpp $(SRCS)
	mkdir -p $(@D)
...
$(WASM_BUILD_DIR)/el-passo-user.js : wasm-src/el-passo-user.cc $(MCL_DIR)/src/fp.cpp $(SRCS)
	mkdir -p $(@D)
